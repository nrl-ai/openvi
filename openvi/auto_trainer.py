...
class AutoTrainer:
    ...
    def training_process_func(self):
        ...
        for file_name in os.listdir(self.current_training_path):
            os.system("cp -r {0} {1}".format(self.current_training_path / file_name , model_path / file_name))
            # print("xxx", self.current_training_path / file_name, model_path / file_name, file_name)
            # os.chmod(self.current_training_path / file_name, 0o777)
            # shutil.copy(
        ...
        # os.remove(self.current_training_path)
