...
def run_resnet18(image):
    onnx_path = os.path.join(base_path, "out_snapshot/r18_classify/r18_classify_best_model.onnx")
    ...
    print(pred, index)
    label = f'{pred} - {index}'
    cv2.putText(input_img, label, (20,20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), thickness=2)
