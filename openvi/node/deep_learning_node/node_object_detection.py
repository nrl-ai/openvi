...
from node.deep_learning_node.object_detection.nanodet.nanodet import Nanodet
...
class Node(DpgNodeABC):
    ...
    # モデル設定
    _model_class = {
        'NanoDet-Plus-m (416x416)': Nanodet,
    ...
    _model_path_setting = {
        'NanoDet-Plus-m (416x416)':
         _model_base_path + 'nanodet/model/nanodet.onnx',
        'YOLOX-Nano(416x416)':
    ...
    _model_class_name_list = {
        'NanoDet-Plus-m (416x416)': coco_class_names,
