...
class Node(DpgNodeABC):
    ...
    _model_path_setting = {
        ...
        "Resnet34": _model_base_path
        + "opencv/model/r34_classify/r34_classify_best_model.onnx",
        "Resnet50": _model_base_path
        + "opencv/model/r50_classify/r50_classify_best_model.onnx",
        "MobileNetV2": _model_base_path
        + "opencv/model/mbv2_classify/mbv2_classify_best_model.onnx",
        "MobileNetV3 Small": _model_base_path
        + "opencv/model/mbv3_classify/mbv3_classify_best_model.onnx",
    }
