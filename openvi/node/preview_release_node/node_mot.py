...
from openvi.node.preview_release_node.mot.motpy.motpy import Motpy
...
class Node(DpgNodeABC):
    ...
    node_label = "Multi Object Tracking"
    ...
    def update(
        ...
        if frame is not None:
            if (
                src_node_name == "ObjectDetection"
                or src_node_name == "Classification"
            ):
                # 描画
